...
Business Context
Retail organizations require clear visibility into revenue trends, cost structures, and product performance in order to improve profitability and optimize pricing strategy.

Project Objectives
Design a scalable analytics architecture for retail performance monitoring
